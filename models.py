...
class RegressionModel(Module):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        super().__init__()
        self.linearLayer1 = Linear(1, 400)
        self.linearLayer2 = Linear(400, 1)
    ...
    def forward(self, x):
        ...
        """
        "*** YOUR CODE HERE ***"
        result = self.linearLayer1(x)
        result = relu(result)
        result = self.linearLayer2(result)
        return result
    ...
    def train(self, dataset):
        ...
        """
        "*** YOUR CODE HERE ***"
        dataloader = DataLoader(dataset, batch_size=int(len(dataset)/4), shuffle=True)
        ...
        while (True):
            ...
            for sample in dataloader:
                ...
                loss.backward()
                optimizer.step()
                sumofloss = sumofloss + loss
                averageloss = float(sumofloss / len(dataloader))
            if (averageloss < 0.02):
                break
...
class DigitClassificationModel(Module):
    ...
    def __init__(self):
        ...
        output_size = 10
        "*** YOUR CODE HERE ***"
        self.linearlayer1 = Linear(input_size, 300)
        self.linearlayer2 = Linear(300, output_size)
